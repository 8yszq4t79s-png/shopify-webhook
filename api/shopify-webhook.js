...
function sendConfirmationEmail(orderData) {
  return new Promise((resolve, reject) => {
    ...
    const htmlEmail = '<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"></head><body style="margin:0;padding:0;font-family:Georgia,Times New Roman,serif;background-color:#f5f5f5;"><div style="max-width:600px;margin:0 auto;background-color:#ffffff;"><div style="background-color:#E8E4DC;padding:48px 40px;text-align:center;"><h1 style="font-size:42px;font-weight:400;color:#BAA684;letter-spacing:1px;margin:0;">Lumbr</h1></div><div style="padding:48px 40px;background-color:#ffffff;"><h2 style="font-size:28px;font-weight:400;color:#000000;margin:0 0 24px 0;line-height:1.3;">Thank you for your order</h2><p style="font-family:Arial,sans-serif;font-size:15px;line-height:1.6;color:#666666;margin:0 0 16px 0;">We\'re excited to start handcrafting your bespoke furniture in our Staffordshire workshop.</p><div style="background-color:#FAFAFA;border:1px solid #E8E4DC;padding:24px;margin:32px 0;"><div style="font-family:Arial,sans-serif;padding:8px 0;font-size:14px;margin-bottom:12px;"><span style="color:#999999;text-transform:uppercase;font-size:11px;letter-spacing:0.5px;display:block;margin-bottom:4px;">ORDER NUMBER</span><span style="color:#000000;font-weight:500;">#' + orderData.orderNumber + '</span></div><div style="font-family:Arial,sans-serif;padding:8px 0;font-size:14px;margin-bottom:12px;"><span style="color:#999999;text-transform:uppercase;font-size:11px;letter-spacing:0.5px;display:block;margin-bottom:4px;">ORDER DATE</span><span style="color:#000000;font-weight:500;">' + orderData.orderDate + '</span></div><div style="font-family:Arial,sans-serif;padding:8px 0;font-size:14px;"><span style="color:#999999;text-transform:uppercase;font-size:11px;letter-spacing:0.5px;display:block;margin-bottom:4px;">STATUS</span><span style="color:#000000;font-weight:500;">Order Confirmed</span></div></div><p style="font-family:Arial,sans-serif;font-size:15px;line-height:1.6;color:#666666;margin:0 0 16px 0;">Track your order\'s progress from workshop to doorstep. You\'ll need your order number and delivery postcode to access tracking.</p><center><a href="' + trackingUrl + '" style="display:inline-block;padding:16px 40px;background-color:#000000;color:#ffffff;text-decoration:none;font-family:Arial,sans-serif;font-size:14px;font-weight:500;letter-spacing:0.5px;margin:32px 0;border-radius:2px;">TRACK YOUR ORDER</a></center><div style="height:1px;background-color:#E8E4DC;margin:32px 0;"></div><p style="font-family:Arial,sans-serif;font-size:15px;line-height:1.6;color:#666666;margin:0 0 16px 0;">We\'ll keep you updated throughout the crafting process. If you have any questions, simply reply to this email.</p><p style="font-family:Arial,sans-serif;font-size:15px;line-height:1.6;color:#666666;margin:24px 0 0 0;">— The Lumbr Team</p></div><div style="background-color:#E8E4DC;padding:40px;text-align:center;"><p style="font-family:Arial,sans-serif;font-size:12px;color:#999999;margin:0;line-height:1.6;">Handmade in England using kiln dried, sub 10% best grade timber</p><p style="font-family:Arial,sans-serif;font-size:12px;color:#999999;margin:8px 0 0 0;">&copy; ' + new Date().getFullYear() + ' Lumbr. All rights reserved.</p></div></div></body></html>';
